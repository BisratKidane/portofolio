...
- [x] 21-01-PLAN.md — getGeezDisplay pure helper (TDD): null | { text, lang: 'ti' } from member.geezFullname (VIEW-03)
...
- [x] 22-02-PLAN.md — Wire getGeezDisplay into MemberNode/AdminMemberTable/MemberCard + Ge'ez admin-table search (VIEW-01, VIEW-02, FIND-01)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 22-03-PLAN.md — Manual visual sign-off: longest real Ge'ez name on constrained /family card
