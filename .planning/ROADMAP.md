...
- [x] **Phase 17: /family Deep Tree Visualization** - Linked members explore the whole family as a pannable, zoomable tree. (completed 2026-07-25)
...
- [x] 16-05-PLAN.md — Remove (D-11) + serve (D-07) routes, full backend suite gate (PHOTO-01, PHOTO-02, QUAL-01)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 16-06-PLAN.md — Frontend primitives: photoClient, MemberAvatarImage, PhotoCropDialog (PHOTO-01)
...
- [x] 17-03-PLAN.md — FamilyTreeCanvas + MemberNode + UnionNode: production spouse-pairing render, collapse/expand, find-me/search/zoom/minimap, render-smoke tests (TREE-01, TREE-02)

**Wave 3** *(blocked on 17-01 and 17-03 completion)*

- [x] 17-04-PLAN.md — MemberDetailPanel + FamilyTreePage flat-fetch orchestration, /family route + nav, full-suite gate (TREE-02, TREE-04, QUAL-02, QUAL-03)
